...
class Horseclub_Enqueue {

	public $scripts = array();

	public function horseclub_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'horseclub_frontend_enqueue_scripts', ) );
	}

	public function horseclub_frontend_enqueue_scripts( ) {
