...
// image default alt
if( ! function_exists( 'horseclub_img_default_alt' ) ) {
	function horseclub_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'horseclub_img_tag' ) ) {
	function horseclub_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = horseclub_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'horseclub_anchor_tag' ) ) {
	function horseclub_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'horseclub' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'horseclub_heading_tag' ) ) {
	function horseclub_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'horseclub' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'horseclub_paragraph_tag' ) ) {
	function horseclub_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'horseclub_other_tag' ) ) {
	function horseclub_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'horseclub_button_element ' ) ) {
	function horseclub_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'horseclub' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
