...
class horseclub_author_widget extends WP_Widget {
...
'horseclub_author_widget', 


// Widget name will appear in UI
esc_html__( '[ Horseclub ] Author Widget', 'horseclub' ),

// Widget description
array( 'description' => esc_html__( 'Add author content', 'horseclub' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Author Name', 'horseclub' );
}
...
?>
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:' ,'horseclub'); ?></label> 
<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
</p>

<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'Short Descriptions:' ,'horseclub'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Facebook Url' ) ); ?>"><?php esc_html_e( 'Facebook Url:' ,'horseclub'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Twitter Url' ) ); ?>"><?php esc_html_e( 'Twitter Url:' ,'horseclub'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Dribbble Url' ) ); ?>"><?php esc_html_e( 'Dribbble Url:' ,'horseclub'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Behance Url' ) ); ?>"><?php esc_html_e( 'Behance Url:' ,'horseclub'); ?></label> 
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'horseclub' ); ?>:</label>
	<div class="horseclub-media-container">
		<div class="horseclub-media-inner">
			...
			<span class="horseclub-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'horseclub' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="horseclub-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'horseclub' ); ?>" class="button horseclub-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'horseclub' ) : __( 'Select Image', 'horseclub' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button horseclub-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
.horseclub-media-container {
	width: 98%;
}

.horseclub-media-inner {
...
.horseclub-media-remove {
	float: left;
	width: 48%;
}

.horseclub-media-upload {
	float: right;
	width: 48%;
}
</style>
...
jQuery(function($){
    ...
    wpshed_image_upload( '.horseclub-media-upload' );
    ...
    wpshed_image_remove( '.horseclub-media-remove' );
...
} // Class horseclub_author_widget ends here


// Register and load the widget
function horseclub_author_load_widget() {
	register_widget( 'horseclub_author_widget' );
}
add_action( 'widgets_init', 'horseclub_author_load_widget' );