...
function horseclub_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'horseclub' ),
        'next_string'     => esc_html__( '&raquo;', 'horseclub' ),
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'horseclub_pagination_defaults', $defaults )
    );
