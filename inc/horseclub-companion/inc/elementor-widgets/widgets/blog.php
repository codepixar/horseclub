...
class Horseclub_Blog extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'blog_content',
            [
                'label' => __( 'Blgo', 'horseclub' ),
            ]
        );
        $this->add_control(
            'blog_sectiontitle',
            [
                'label'       => esc_html__( 'Section Title', 'horseclub' ),
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__( 'Section Sub Title', 'horseclub' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
            ]
        );
        $this->add_control(
            'blog_limit',
            [
                'label'     => esc_html__( 'Post Limit', 'horseclub' ),
                'type'      => Controls_Manager::TEXT,
                'default'   => 3
            ]
        );
        ...
        $this->add_control(
            'color_blogtitle', [
                'label'     => __( 'Blog Title Color', 'horseclub' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222',
                'selectors' => [
        ...
        $this->add_control(
            'color_blogtitlehov', [
                'label'     => __( 'Blog Title Hover Color', 'horseclub' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222',
                'selectors' => [
        ...
        $this->add_control(
            'color_blogtext', [
                'label'     => __( 'Blog Text Color', 'horseclub' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
        ...
        $this->add_control(
            'color_tagname', [
                'label'     => __( 'Tags Name Color', 'horseclub' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_tagenamehover', [
                'label'     => __( 'Tags Name Hover Color', 'horseclub' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222',
                'selectors' => [
        ...
        $this->add_control(
            'color_tagbg', [
                'label'     => __( 'Tags Background Color', 'horseclub' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#f45622',
                'selectors' => [
        ...
        $this->add_control(
            'color_taghoverbg', [
                'label'     => __( 'Tags Hover Background Color', 'horseclub' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
