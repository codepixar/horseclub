...
class horseclub_social_widget extends WP_Widget {
...
'horseclub_social_widget', 


// Widget name will appear in UI
esc_html__( '[ Horseclub ] Social Widget', 'horseclub' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'horseclub' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'horseclub' );
}
...
} // Class horseclub_social_widget ends here


// Register and load the widget
function horseclub_social_load_widget() {
	register_widget( 'horseclub_social_widget' );
}
add_action( 'widgets_init', 'horseclub_social_load_widget' );