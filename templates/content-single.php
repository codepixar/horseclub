...
<div id="<?php the_ID(); ?>" <?php post_class( esc_attr( 'single-blog-post content--area' ) ); ?>>
	 ...
	 * Post social share
	 * @Hook  horseclub_blog_posts_content
	 *
	 * @Hooked horseclub_blog_posts_content_cb
	 * 
	 *
	 */
	do_action( 'horseclub_blog_posts_content' );
	 ...
	 * and biography
	 * @Hook  horseclub_blog_single_meta
	 * 
	 * @Hooked horseclub_blog_single_meta_cb
	 * 
	 *
	 */
	do_action( 'horseclub_blog_single_meta' );
